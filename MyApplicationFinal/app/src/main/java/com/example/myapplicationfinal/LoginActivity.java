...
import com.example.myapplicationfinal.bean.UserInfo;
import com.example.myapplicationfinal.database.UserDBHelper;
import com.example.myapplicationfinal.util.DateUtil;
import com.example.myapplicationfinal.util.ViewUtil;
...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    // 初始化用户类型的下拉框
    private String[] typeArray = {"个人用户", "公司用户","18990190杨代华"};
