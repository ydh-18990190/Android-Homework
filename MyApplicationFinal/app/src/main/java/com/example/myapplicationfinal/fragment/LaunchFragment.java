package com.example.myapplicationfinal.fragment;
...
import com.example.myapplicationfinal.LoginActivity;
import com.example.myapplicationfinal.MainActivity;
...
public class LaunchFragment extends Fragment {
    ...
    // 获取该碎片的一个实例
    public static com.example.myapplicationfinal.fragment.LaunchFragment newInstance(int position, int image_id) {
        com.example.myapplicationfinal.fragment.LaunchFragment fragment = new com.example.myapplicationfinal.fragment.LaunchFragment(); // 创建该碎片的一个实例
